...
func process(delta, first_time_entering):
	...
	if first_time_entering:
		...
		parent.play_animation("melee_swipe_turn_left")
		parent.sprite.position -= Vector2(100, 0)
...
#		var target = SWIPE_PROJECTILE_RANGE * direction
		...
		parent.get_node("Origin/SwipeOrigin").scale = Vector2(-1, 1)
