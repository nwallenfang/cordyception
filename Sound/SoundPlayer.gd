...
const fadeout_duration: float = 2.8
const psych_fadein := 1.2
const combat_max_volume := -5.9
const ambient_max_volume := -5.9
...
func switch_music():
	...
	if combat:
		...
		tween_in.interpolate_property($Ambient, "volume_db", -80, ambient_max_volume, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	else:
		# fade ambient music in and combat out
		print("fade ambient music in and combat out")
		tween_out.interpolate_property($Ambient, "volume_db", ambient_max_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
		tween_in.interpolate_property($Combat, "volume_db", -80, combat_max_volume, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
...
func switch_to_psychedelic():
	...
	tween_in.interpolate_property($Psychedelic, "volume_db", -16, psychedelic_max_volume, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	tween_in.start()
	tween_out.start()
	$Psychedelic.play()
...
func switch_back_from_psychdelic():
	...
	if combat:
		...
		$Ambient.play()
		tween_in.interpolate_property($Ambient, "volume_db", -80, ambient_max_volume, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	tween_out.interpolate_property($Psychedelic, "volume_db", psychedelic_max_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
...
func stop_music():
	...
	if $Psychedelic.playing:
		tween_out.interpolate_property($Psychedelic, "volume_db", psychedelic_max_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	if $Stage.playing:
		tween_out.interpolate_property($Stage, "volume_db", stage_base_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	if combat:
		tween_out.interpolate_property($Combat, "volume_db", combat_max_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	else:
		tween_out.interpolate_property($Ambient, "volume_db", ambient_max_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
...
func stop_stage_music():
	tween_out.reset_all()
	tween_out.interpolate_property($Stage, "volume_db", stage_dialog_volume, -80, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	tween_out.start()
...
func start_stage_music():
	...
	$Stage.play()
	tween_in.reset_all()
	tween_in.interpolate_property($Stage, "volume_db", -12, stage_dialog_volume, fadeout_duration, Tween.TRANS_SINE, Tween.EASE_IN, 0)
	tween_in.start()
	tween_out.start()
